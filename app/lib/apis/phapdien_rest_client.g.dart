...
part of 'phapdien_rest_client.dart';
...
class _PhapdienRestClient implements PhapdienRestClient {
  ...
  @override
  Future<dynamic> askPhapdienChat(AskPhadienChatRequest request) async {
    const _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
  ...
  @override
  Future<dynamic> getRandomSuggestionQuestions() async {
    const _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final Map<String, dynamic>? _data = null;
